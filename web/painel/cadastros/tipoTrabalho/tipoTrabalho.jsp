...
<script>
    ...
    function deletar(codigo, situacao) {
        ...
        if (situacao == 'I') {
            titulo = "Você deseja realmente ativar o tipo de trabalho?";
            confirmButtonText = "Sim, ative o tipo de trabalho!";
            tituloConfirmacao = "Tipo de trabalho ativado com sucesso!";

        } else {
            titulo = "Você deseja realmente inativar o tipo de trabalho?";
                            ...
                            function (data) {
                                if (data == 1) {
                                    ...
                                    Swal.fire({
                                        ...
                                        icon: 'error',
                                        title: 'Erro',
                                        text: 'Não foi possível ativar/inativar o Tipo de Trabalho!',
                                        showConfirmButton: true,
                                        timer: 10000
                                    }).then(function () {
                                        window.location.href = "${pageContext.request.contextPath}/TipoTrabalhoListar";
    ...
    function validarCampos() {
        ...
        if (document.getElementById("descricao").value == '') {
            Swal.fire({
                position: 'center',
                icon: 'error',
                title: 'Verifique a descrição do Tipo do Trabalho',
                showConfirmButton: true,
                timer: 2000
            });
            $("#descricao").focus();
                    ...
                    function (data) {
                        ...
                        if (data == 1) {
                            ...
                            Swal.fire({
                                ...
                                icon: 'error',
                                title: 'Erro',
                                text: 'Não foi possível gravar o Tipo do Trabalho!',
                                showConfirmButton: true,
                                timer: 10000
                            }).then(function () {
                                window.location.href = "${pageContext.request.contextPath}/TipoTrabalhoListar";
