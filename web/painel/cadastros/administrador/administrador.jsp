                    ...
                    <table id="datatable" class="display">
                        ...
                        <tbody>
                            <c:forEach var="administrador" items="${administradores}">
                                <tr>
                                    <td align="right">${administrador.idAdministrador}</td>
                                    <td align="left">${administrador.nomeRazaoPessoa}</td>
                                    <td align="left">${administrador.cpfCnpjPessoa}</td>
                                    ...
                                    <td align="center">
                                        <a href="#" onclick="deletar(${administrador.idAdministrador}, '${administrador.situacao}')">
                                            <button class="btn
                                                    <c:out value="${administrador.situacao == 'A' ? 'btn-danger':'btn-success'}"/>">
                                                <i class="fas fa-fw
                                                   <c:out value="${administrador.situacao == 'A' ? 'fa-times' : 'fas fa-check'}"/>"></i>
                                                <Strong>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="hidden" name="idadministrador" id="idadministrador" value="" readonly="readonly"/>
...
<script>
    ...
    function deletar(codigo, situacao) {
        ...
        if (situacao == 'I') {
            titulo = "Você deseja realmente ativar o administrador?";
            confirmButtonText = "Sim, ative o administrador!";
            tituloConfirmacao = "Administrador ativado com sucesso!";

        } else {
            titulo = "Você deseja realmente inativar o administrador?";
            confirmButtonText = "Sim, inative o administrador!";
            tituloConfirmacao = "Administrador inativado com sucesso!";
        }
                            ...
                            function (data) {
                                if (data == 1) {
                                    ...
                                    Swal.fire({
                                        ...
                                        icon: 'error',
                                        title: 'Erro',
                                        text: 'Não foi possível ativar/inativar administrador!',
                                        showConfirmButton: true,
                                        timer: 10000
                                    }).then(function () {
                                        window.location.href = "${pageContext.request.contextPath}/AdministradorListar";
    ...
    function menuAtivo() {
        document.getElementById('titulopainel').innerHTML = "<strong>Administrador</strong>";
        ...
        document.getElementById('menuadministrador').classList.add("active");
    }
