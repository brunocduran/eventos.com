                ...
                <div class="card-body">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input class="form-control" type="hidden" name="idpessoa" id="idpessoa" value="${organizador.idPessoa}" readonly="readonly"/>
                            <input class="form-control" type="hidden" name="idorganizador" id="idorganizador" value="${organizador.idOrganizador}" readonly="readonly"/>
                            <input class="form-control" type="hidden" name="situacao" id="situacao" value="${organizador.situacao}" readonly="readonly"/>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-line row">
                                <div class="col-sm">
                                    ...
                                    <input class="form-control" type="text" name="cpfcnpjpessoa" id="cpfcnpjpessoa" value="${organizador.cpfCnpjPessoa}" />
                                </div>
                                <div class="col-sm">
                                    <label>RG/IE</label>
                                    <input class="form-control" type="text" name="rgiepessoa" id="rgiepessoa" value="${organizador.rgIePessoa}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-line row">
                                <div class="col-sm">
                                    ...
                                    <input class="form-control" type="text" name="nomerazaopessoa" id="nomerazaopessoa" value="${organizador.nomeRazaoPessoa}"/>
                                </div>
                                <div class="col-sm">
                                    <label>Logradouro</label>
                                    <input class="form-control" type="text" name="logradouropessoa" id="logradouropessoa" value="${organizador.logradouroPessoa}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-line row">
                                <div class="col-sm">
                                    <label>Número</label>
                                    <input class="form-control" type="text" name="numlogradouropessoa" id="numlogradouropessoa" value="${organizador.numLogradouroPessoa}"/>
                                </div>
                                <div class="col-sm">
                                    <label>Bairro</label>
                                    <input class="form-control" type="text" name="bairropessoa" id="bairropessoa" value="${organizador.bairroPessoa}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-line row">
                                <div class="col-sm">
                                    <label>CEP</label>
                                    <input class="form-control" type="text" name="ceppessoa" id="ceppessoa" value="${organizador.cepPessoa}" placeholder="00000-000" oninput="criaMascaraCEP()" maxLength="8"/>
                                </div>
                                <div class="col-sm">
                                    <label>Estado</label>
                        ...
                        <div class="form-group">
                            <div class="form-line row">
                                <div class="col-sm">
                                    ...
                                    <input class="form-control" type="tel" name="telefonepessoa" id="telefonepessoa" value="${organizador.telefonePessoa}" placeholder="(00) 00000-0000" oninput="criaMascaraTelefone()" maxLength="11"/>
                                </div>
                                <div class="col-sm">
                                    <label>E-mail</label>
                                    <input class="form-control" type="email" name="emailpessoa" id="emailpessoa" placeholder="exemplo@email.com" value="${organizador.emailPessoa}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-line row">
                                <div class="col-sm">
                                    ...
                                    <input class="form-control" type="date" name="datanascfundpessoa" id="datanascfundpessoa" value="${organizador.dataNascFundPessoa}"/>
                                </div>
                                <div class="col-sm">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="login" id="login" value="${organizador.login}" size="20" maxlength="20" readonly="true" required/>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <label>Senha</label>
                                    <input class="form-control" type="password" name="senha" id="senha" value="${organizador.senha}" size="20" maxlength="20" required/>
                                </div>
                            </div>
                        </div>
...
<script>
                    ...
                    function (data) {
                        ...
                        if (data == 1) {
                            Swal.fire({
                                ...
                                window.location.href = "${pageContext.request.contextPath}/OrganizadorLogadoCarregar?idOrganizador=${sessionScope.idusuario}";
                            })
                        } else {
                            Swal.fire({
                                position: 'center',
    ...
    cidade = ${organizador.cidade.idCidade};
    ...
    function menuAtivo() {
        document.getElementById('titulopainel').innerHTML = "<strong>Cadastro do Organizador</strong>";
    }
        ...
        $(document).ready(function () {
            $.getJSON('PessoaBuscarCpfCnpj', {cpfcnpjpessoa: idM, tipopessoa: tipoPessoa}, function (respostaAdm) {
                ...
                if (respostaAdm != null) {
                    ...
                    if (respostaAdm.idOrganizador == ${sessionScope.idusuario}) {
