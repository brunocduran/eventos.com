    ...
    <body class="hold-transition login-page">
        ...
        <script>
            ...
            function logar(){
                    ...
                    if ($('#login').val() === "") {
                        $('#login').focus();
                        $('#erro').html("<div> <FONT COLOR='red'>Por favor, preencher o campo usuário.</FONT> </div>").show();
                        tempo();
                        return false;
                    }
                    if ($('#senha').val() === "") {
                        $('#senha').focus();
                        $('#erro').html("<div> <FONT COLOR='red'>Por favor, preencher o campo senha.</FONT> </div>").show();
                        tempo();
                        return false;
                    }
                        ...
                        success:
                                function (data) {
                                    ...
                                    if (data == 'ok') {
                                        ...
                                        $('#tipo').empty();
                                        document.getElementById("selecaoUsuario").style.display = "none";
                                        $('#erro').html("<div> <FONT COLOR='red'>Usuário ou senha inválidos!</FONT> </div>").show();
                                    } else if (data == '1') {
                                        $('#tipo').empty();
                                        document.getElementById("selecaoUsuario").style.display = "none";
                                        $('#login').focus();
                                        $('#login').val("");
                                        $('#senha').val("");
                                        $('#erro').html("<div> <FONT COLOR='red'>Nível de permissão inválido!</FONT> </div>").show();
                                    } else {
