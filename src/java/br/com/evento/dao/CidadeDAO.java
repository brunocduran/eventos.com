...
public class CidadeDAO implements GenericDAO{
    ...
    public Boolean alterar(Object objeto) {
        ...
        try {
            ...
            try {
                System.out.println("Problemas ao alterar a cidade na DAO! Erro: " + ex.getMessage());
                ex.printStackTrace();
                conexao.rollback();
            } catch (SQLException e) {
                System.out.println("Erro:" + e.getMessage());
    ...
    public Boolean excluir(int numero) {
        ...
        try {
            ...
            System.out.println("Problemas ao excluir a Cidade na DAO! Erro: " + ex.getMessage());
            try {
                conexao.rollback();
            } catch (SQLException e) {
    ...
    public Object carregar(int numero) {
        ...
        try {
            ...
            System.out.println("Problemas ao carregar Cidade na DAO! Erro:" + ex.getMessage());
            return false;
        }
    }
