 ...
 * @author bruno
 */
@WebServlet(name = "EventoGerenciarParticipante", urlPatterns = {"/EventoGerenciarParticipante"})
public class EventoGerenciarParticipante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (verificaEvento >= 1) {
                request.getRequestDispatcher("/painel/cadastros/evento/eventoGerenciarParticipante.jsp").forward(request, response);
            } else {
