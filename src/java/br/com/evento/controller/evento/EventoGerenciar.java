 ...
 * @author bruno
 */
@WebServlet(name = "EventoGerenciar", urlPatterns = {"/EventoGerenciar"})
public class EventoGerenciar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (verificaEvento >= 1) {
                request.getRequestDispatcher("/painel/cadastros/evento/eventoGerenciar.jsp").forward(request, response);
            } else {
