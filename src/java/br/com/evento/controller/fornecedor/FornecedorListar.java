...
public class FornecedorListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("tipostrabalhos", oTipoTrabalhoDAO.listar());
            
            
            request.getRequestDispatcher("painel/cadastros/fornecedor/fornecedor.jsp").forward(request, response);
        } catch(Exception ex){
