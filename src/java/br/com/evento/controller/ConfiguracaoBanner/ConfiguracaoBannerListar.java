 ...
 * @author johat
 */
@WebServlet(name = "ConfiguracaoBannerListar", urlPatterns = {"/ConfiguracaoBannerListar"})
public class ConfiguracaoBannerListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            GenericDAO dao = new ConfiguracaoBannerDAO();
