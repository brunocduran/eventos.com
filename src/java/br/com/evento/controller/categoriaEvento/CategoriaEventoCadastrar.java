 ...
 * @author johat
 */
@WebServlet(name = "CategoriaEventoCadastrar", urlPatterns = {"/CategoriaEventoCadastrar"})
public class CategoriaEventoCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            CategoriaEvento oCategoriaEvento = new CategoriaEvento(idCategoriaEvento, nome, situacao);
            
            CategoriaEventoDAO dao = new CategoriaEventoDAO();
            if (dao.cadastrar(oCategoriaEvento)){
