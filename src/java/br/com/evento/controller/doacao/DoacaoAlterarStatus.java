 ...
 * @author bruno
 */
@WebServlet(name = "DoacaoAlterarStatus", urlPatterns = {"/DoacaoAlterarStatus"})
public class DoacaoAlterarStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(dao.excluirAlterarStatus(idDoacao)){
            ...
            System.out.println("Problemas na Servelet ao Excluir Doacao! Erro: "+e.getLocalizedMessage());
            e.printStackTrace();
        }
    }
