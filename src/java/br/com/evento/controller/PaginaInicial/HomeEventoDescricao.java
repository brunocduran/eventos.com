 ...
 * @author bruno
 */
@WebServlet(name = "HomeEventoDescricao", urlPatterns = {"/HomeEventoDescricao"})
public class HomeEventoDescricao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            System.out.println("Problema no servlet ao listar HomeEventoCategoria"+ex.getMessage());
            ex.printStackTrace();
        }
    }
