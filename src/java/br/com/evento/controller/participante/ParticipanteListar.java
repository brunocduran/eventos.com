...
public class ParticipanteListar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("painel/cadastros/participante/participante.jsp").forward(request, response);
        } catch(Exception ex){
            System.out.println("Problemas no Servlet ao listar Participante! Erro: "+ ex.getMessage());
        }
    }
