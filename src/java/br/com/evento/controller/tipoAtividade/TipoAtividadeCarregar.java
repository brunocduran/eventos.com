 ...
 */
package br.com.evento.controller.tipoAtividade;
 ...
 * @author jgcoc
 */
@WebServlet(name = "TipoAtividadeCarregar", urlPatterns = {"/TipoAtividadeCarregar"})
public class TipoAtividadeCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TipoAtividade oTA = (TipoAtividade) dao.carregar(idTipoAtividade);
            
            Gson ogson = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
            String jSon = ogson.toJson(oTA);
            response.getWriter().write(jSon);
        } catch (Exception e) {
            System.out.println("Problemas na Servlet ao carregar Tipo Atividade! Erro: "+e.getMessage());
            e.printStackTrace();
        }
    }
